...
<head>
  ...
  <title>Ebola Portal - Dashboard Page </title>
  <!--     Fonts and icons     -->
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">
            MINISTRY OF HEALTH UGANDA EBOLA STATISTICS FROM ALL THE DISTRICTS ALL OVER THE COUNTRY
          </h6>
        </nav>
 ...
 <!-- End Navbar -->
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of Deaths</p>
                <h4 class="mb-0"><?php echo $death_row['deaths']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder"><?php echo $death_row1['deaths']; ?></span>
                Cases today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of New Cases</p>
                <h4 class="mb-0"><?php echo $new_row['new_cases']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">
                <?php echo $new_row1['new_cases']; ?> </span>
                New cases today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of Confirmed Cases</p>
                <h4 class="mb-0"><?php echo $confirm_row['confirm']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"><?php echo $confirm_row1['confirm']; ?></span>
                 Confirmed cases today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Total No. of Recoveries</p>
                <h4 class="mb-0"><?php echo $rec_row['recover']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-info text-sm font-weight-bolder"><?php echo $rec_row1['recover']; ?>
                </span>Recoveries today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of Inpatient</p>
                <h4 class="mb-0"><?php echo $in_row['inp']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">
              <?php echo $in_row1['inp']; ?></span>
                Admitted today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of Outpatients</p>
                <h4 class="mb-0"><?php echo $out_row['outp']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">
              <?php echo $out_row1['outp']; ?> </span>
                Admitted today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">No. of Contacts</p>
                <h4 class="mb-0"><?php echo $con_row['contact']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">
              <?php echo $con_row1['contact']; ?></span>
                 Contacts today</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Districts with Cases</p>
                <h4 class="mb-0"><?php echo $dis_row['district']; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-info text-sm font-weight-bolder">
                <?php echo $dis_row1['district']; ?>
                </span>Districts today</p>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    new Chart(ctx3, {
      type: "line",
      data: {
        labels: [ "Mubende", "Kagadi", "Kyegewa", "Jinja", "Kampala","Wakiso"],
        datasets: [{
          label: "Ebola patients",
          tension: 0,
          borderWidth: 0,
